...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/20 18:34:59 by ktennie           #+#    #+#              #
#    Updated: 2020/02/04 11:12:36 by ktennie          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	  ...
	  ft_strnstr.c ft_strrchr.c ft_strstr.c ft_strsub.c ft_strtrim.c \
	  ft_strsplit.c ft_itoa.c ft_putchar.c ft_putstr.c ft_putendl.c \
	  ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c \
	  ft_putnbr_fd.c ft_tolower.c ft_toupper.c ft_lstnew.c ft_lstdelone.c \
...
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	  ...
	  ft_strnstr.o ft_strrchr.o ft_strstr.o ft_strsub.o ft_strtrim.o \
	  ft_strsplit.o ft_itoa.o ft_putchar.o ft_putstr.o ft_putendl.o \
	  ft_putnbr.o ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o \
	  ft_putnbr_fd.o ft_tolower.o ft_toupper.o ft_lstnew.o ft_lstdelone.o \
	  ft_lstdel.o ft_lstadd.o ft_lstiter.o

all: $(NAME)

$(NAME):
		clang $(FLAG) -c $(SRC) -I ../includes
		ar rc $(NAME) $(OBJ)
		ranlib $(NAME)
